...
public class Deferred<T> {
	...
	T resolvedValue;
	boolean isResolved=false;														//will be true after Resolved was called
	private ConcurrentLinkedQueue<Runnable> callBacksQ=new ConcurrentLinkedQueue<Runnable>();	//list of Runnable's
    ...
    public void resolve(T value) {
    	if(this.isResolved)									//if this is already resolved
    		...
    		while(callBacksQ.isEmpty()==false){		//run all runnables
